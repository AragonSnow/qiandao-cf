...
-- Schema tiebasign
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `tiebasign` DEFAULT CHARACTER SET utf8 ;
USE `tiebasign` ;

-- -----------------------------------------------------
-- Table `tiebasign`.`user`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `tiebasign`.`user` (
...
-- Table `tiebasign`.`tpl`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `tiebasign`.`tpl` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `tiebasign`.`task`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `tiebasign`.`task` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `tiebasign`.`tasklog`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `tiebasign`.`tasklog` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `tiebasign`.`push_request`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `tiebasign`.`push_request` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
...
CREATE USER 'tiebasign';

GRANT SELECT, INSERT, TRIGGER ON TABLE `tiebasign`.* TO 'tiebasign';
GRANT SELECT ON TABLE `tiebasign`.* TO 'tiebasign';
GRANT SELECT, INSERT, TRIGGER, UPDATE, DELETE ON TABLE `tiebasign`.* TO 'tiebasign';
